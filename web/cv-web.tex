...
\newline
{\bfseries Tech/Tools}: React, Next.js, SQL, MongoDB, CI/CD, Docker, AWS, GitHub Actions, Web protocols (TCP/UDP, HTTP)
...
\newrole{Tail'ed}{Full-stack developer intern}{Montreal, Quebec}{June 2024 --- September 2024}
\begin{bulletpoints}
