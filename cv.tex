...
\newcommand{\shortrole}[3]{
    {\normalfont\textbf{#1} --- \textit{#2}\hfill#3}
}
...
\begin{bulletpoints}
    ...
    \item Took the initiative to add automatic unit tests, improving the test coverage from 0\% to 75\% on an internal API
...
\begin{bulletpoints}
    \item Co-researcher in a statistical study on the usability of Debian, resulting in giving a talk at a worldwide open-source conference. Created data analysis software to automate 63 statistical tests
