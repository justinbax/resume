...
{\bfseries Programming Languages}: C, C++, Python, Java, TypeScript, 6502 Assembly
\newline
{\bfseries Tech/Tools}: FreeRTOS, Linux, MongoDB, SQL, Next.js, AWS, GitHub Actions, CI/CD


\section*{Professional experience}

\newrole{UW Orbital}{Firmware Developer}{Waterloo, Ontario}{September 2024 --- Present}
\begin{bulletpoints}
    \item Optimized the file system to discard unused satellite telemetry files once sent to the ground station
    \item Created a thermal management system and a temperature driver for the LM75BD
\end{bulletpoints}
